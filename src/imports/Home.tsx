import svgPaths from "./svg-34il4djopb";
...
function Button() {
  return (
    <div
      className="bg-[#ff7eb6] box-border content-stretch flex gap-[12px] h-[54px] items-center justify-center pl-[24px] pr-[6px] py-[20px] relative rounded-[100px] shrink-0"
      data-name="button"
    >
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="arrow">
      <svg
        ...
        viewBox="0 0 24 24"
      >
        <g clipPath="url(#clip0_1_1149)" id="arrow">
          <path
            d={svgPaths.p3589c00}
            fill="var(--fill-0, #ff7eb6)"
            id="Vector"
...
function TitleAndArrow() {
  return (
    ...
    >
      <p className="font-['Manrope',sans-serif] font-bold leading-[1.5] relative shrink-0 text-[#ff7eb6] text-[16px] text-nowrap uppercase whitespace-pre">
        Live Demo
      </p>
      <Arrow />
    </div>
...
function Button1() {
  return (
    <div
      className="bg-[#ff7eb6] box-border content-stretch flex gap-[16px] h-[54px] items-center justify-center px-[40px] py-[20px] relative rounded-[100px] shrink-0"
      data-name="button"
    >
      <p className="font-['Manrope',sans-serif] font-bold leading-none relative shrink-0 text-[16px] text-neutral-950 text-nowrap uppercase whitespace-pre">
        Submit
