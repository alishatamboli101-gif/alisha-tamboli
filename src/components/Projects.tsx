...
export default function Projects({ navigate }: ProjectsProps) {
  ...
  return (
    <>
      <Helmet>
        <title>Projects by Alisha Tamboli - Front End Engineer Portfolio</title>
        <meta
          name="description"
          content="Explore the projects by Alisha Tamboli, including employee portals, e-commerce experiences, analytics dashboards, and more."
        />
        <meta
          name="keywords"
          content="Alisha Tamboli, Projects, Portfolio, React Developer, JavaScript, Next.js, Front End Engineer"
        />
        <link rel="canonical" href="https://alishatamboli.com/projects" />
      </Helmet>
      <div className="bg-[#0a0a0a] min-h-screen">
        ...
        <section className="pt-32 pb-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="space-y-4 mb-16">
              <h1 className="text-[80px] lg:text-[90px] text-[#ffffff] leading-[0.9]">
                ALL PROJECTS
              </h1>
        ...
        <section className="pb-12 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="mb-12">
              <h2 className="text-[56px] text-[#ffffff] leading-[0.9]">
                NOTABLE PROJECTS
              </h2>
            </div>
                      ...
                      {project.url && project.url !== "#" && (
                        ...
                        >
                          <div className="flex items-center gap-1">
                            <span className="font-['Manrope',sans-serif] font-bold text-[#ff7eb6] text-[14px] uppercase">
                              Live Demo
                            </span>
                            <svg
                              width="20"
                              ...
                              fill="none"
                            >
                              <path d={svgPaths.p3589c00} fill="#ff7eb6" />
                            </svg>
                          </div>
              ...
              {personalProjects.map((project) => (
                ...
                >
                  ...
                  <div className="p-6 space-y-4">
                    <h3 className="font-['Manrope',sans-serif] text-[24px] text-[#ffffff] leading-[1.4]">
                      {project.title}
                    </h3>
                    {project.url !== "#" && (
                      <a
        ...
        <section className="py-20 px-6 border-t border-[#484848]">
          <div className="max-w-7xl mx-auto text-center">
            <div className="space-y-8">
              ...
              <button
                onClick={() => navigate("/")}
                className="inline-flex bg-[#ff7eb6] rounded-full items-center gap-3 pl-6 pr-2 py-3 h-[54px] hover:bg-[#ff5fa2] transition-colors cursor-pointer"
              >
