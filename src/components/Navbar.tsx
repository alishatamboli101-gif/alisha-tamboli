...
export default function Navbar({ navigate, currentPage }: NavbarProps) {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#0a0a0a]/90 backdrop-blur-sm border-b border-[#484848]">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <button
          onClick={toggleMenu}
          className="md:hidden text-[#c7c7c7] hover:text-[#ffffff] transition-colors"
      ...
      {/* Mobile Navigation */}
      {isMenuOpen && (
        <div className="md:hidden bg-[#0a0a0a] border-t border-[#484848]">
